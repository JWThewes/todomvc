...
const styles_selectors_js_3 = require("../../../s3-resource-selector/styles.selectors.js");
const styles_selectors_js_4 = require("../../../s3-resource-selector/test-classes/styles.selectors.js");
class S3ModalWrapper extends modal_1.default {
    findSubmitButton() {
        return this.findComponent(`.${styles_selectors_js_2.default['submit-button']}`, button_1.default);
    }
}
class S3InContextWrapper extends selectors_1.ComponentWrapper {
    findUriInput() {
        return this.findComponent(`.${styles_selectors_js_1.default['layout-uri']}`, input_1.default);
    }
    findVersionsSelect() {
    ...
    findBrowseButton() {
        return this.findComponent(`.${styles_selectors_js_1.default['browse-button']}`, button_1.default);
    }
}
class S3ResourceSelectorWrapper extends selectors_1.ComponentWrapper {
    findAlertSlot() {
        return this.findByClassName(styles_selectors_js_3.default.alert);
    }
    findInContext() {
...
S3ResourceSelectorWrapper.rootSelector = styles_selectors_js_3.default.root;
